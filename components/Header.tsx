...
const Header = ({ onLangChange }: { onLangChange: (e: ChangeEvent<HTMLSelectElement>) => void }) => {
    return (
        <header className="fixed top-0 left-0 right-0 max-h-16">
            <nav className='grid grid-rows-1 grid-cols-4 bg-slate-500 py-3 text-white'>
                <div className='col-span-3 md:col-span-1 flex justify-center items-center'>
                    <Link href='/'>
                        <a className='text-xl md:text-2xl font-bold'>Family Law Fundas RSVP</a>
                    </Link>
                </div>
                <div className='col-span-1 md:col-span-3 flex justify-end items-center mr-8'>
