...
export default function RSVPForm(
    ...
    return <form onSubmit={onSubmit}>
        ...
        <label className="block mt-3 md:mt-8">
        ...
        <button type="submit" className="block mt-4 md:mt-8 bg-slate-600 p-4 rounded-md hover:bg-slate-800 disabled:bg-slate-200 text-white">{content[lang].submit}</button>
    </form>
